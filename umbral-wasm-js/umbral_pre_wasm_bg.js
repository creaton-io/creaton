...
*/
export function encrypt(params, alice_pubkey, plaintext) {
...
* @returns {Uint8Array}
*/
export function decrypt_original(decrypting_key, capsule, ciphertext) {
    try {
...
* @returns {any[]}
*/
export function generate_kfrags(params, delegating_sk, receiving_pubkey, signing_sk, threshold, num_kfrags, sign_delegating_key, sign_receiving_key) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(params, Parameters);
...
* @returns {CapsuleFrag}
*/
export function reencrypt(capsule, kfrag, metadata) {
    _assertClass(capsule, Capsule);
...
export const __wbg_keyfrag_new = function(arg0) {
