            ...
            >
              ...
              <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        ...
                        <br/>
                        <br/>
                        If you want to use Metamask, please purchase a Ledger Hardware wallet so that funds can never be hacked (never give out your recovery phase)!
                      </p>
                    </div>
                  </div>
                </div>
                <div className="mt-5 sm:mt-6">
                  ...
                  >
                    <img className="w-6 mr-2" src="https://cdn.worldvectorlogo.com/logos/metamask.svg" alt="MetaMask logo vector"/>
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 filter drop-shadow-lg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
