...
export const AvatarUpload = ({src = '', size = 'large'}: any) => {
  const size_classes = {
    'large': 'w-32 h-32',
    'profile': 'w-20 h-20',
    'menu':'h-12 w-12 -mt-2',
  ...
  if (!src)
    ...
    return (
      <span>
        ...
        <img className={clsx(size_classes[size], "rounded-full", "border-2", "border-blue-primary", "object-cover", "m-auto")} src={src} alt="profile avatar"/>
      </span>
    );
}
