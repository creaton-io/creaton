            ...
            <li className="py-4 px-6 flex">
              <div className="ml-3">
                <p className="text-white">
                  <span className="font-bold">Staked:</span> {ethers.utils.formatEther(stake.amount)}{' '}
                  {stakedToken.symbol} ({stakedToken.name})
                </p>
                <p className="text-sm text-white">
                  <span className="font-bold">Reacted with:</span> {stake.reaction.reaction.name} (
                  {stake.reaction.reaction.symbol}) to {stake.reaction.nft} <span className="font-bold">TokenId:</span>{' '}
                  {stake.reaction.tokenId}
                </p>
              ...
              <div className="ml-auto text-center">
                ...
                <p className="mt-2 text-sm text-white">
                  {ethers.utils.formatEther(stakedTokenBalance)} ({stakedToken.symbol})
                </p>
              </div>
            </li>
          </div>
