...
export const Chat: FC = () => {
    ...
    async function loadChatList(){
        ...
        const list = await chatClient.conversations.list();
        console.log('Chat list', list);
        setChatList(list);
    }

    async function loadChatMessages(recipient: string){
        if(!chatClient) return;

        const conversation = await chatClient.conversations.newConversation(recipient);
