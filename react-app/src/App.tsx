...
function CreatorHome() {
  ...
  return (
    ...
    <Link to={"/creator/" + currentCreator.creatorContract} className="border-transparent text-purple-500 hover:text-purple-700 hover:border-purple-300 w-1/5 py-4 px-1 text-center border-b-2 font-medium text-sm">
...
function CreatorWallet() {
  ...
  return (<div>
    {currentCreator &&
    <Link to={"/creator/" + currentCreator.creatorContract} className="bg-gray-50 rounded-md p-1 inline-flex items-center justify-center text-gray-400 hover:text-purple-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
