  ...
  return (
    <div className="relative h-full bg-white overflow-hidden z-40">
      <div className="relative h-full pt-1">
        <main>
          <div>
            <img className="hidden lg:block absolute top-0 left-0 w-1/3 h-full object-cover rounded-br-lg"
                 ...
                 alt=""/>
            <span
              className="hidden lg:flex justify-center absolute -mt-12 top-24 clip-24 left-0 w-1/3 h-full object-cover pattern overflow-hidden">
                          ...
                          <div className="flex-1 bg-white flex flex-col justify-between">
                            <div className="flex items-center justify-between">
                              <div className="flex-shrink-0">
                                <a href="#"><img className="h-8 w-8 rounded-full object-cover"
                                                 src="https://arweave.net/BhAz8CXTxUVM0h0tLQ-bF_nnjEkDpwrjRg--DFL2AXc"
                                                 alt="avatar"/></a>
                              </div>
                            </div>
                          </div>
                          <div className="flex-shrink-0 my-6"><img className="h-72 w-80 object-cover filter blur-sm"
                                                                   src="https://arweave.net/MwkwnM2Hh65SM2JtGVCjYbpAO_-ONFpqT17_mEfirtI"/></div>
                          <div>
                            <div className="flex justify-between items-center">
                              <h4 className="text-lg font-semibold text-gray-900">Alexander</h4>
                              ❤️
                            </div>
                            <div><span className="text-xs">Subscribe for</span><span
                              className="font-semibold text-blue ml-2">$6</span></div>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <span className="flex lg:hidden justify-center relative object-cover pattern overflow-hidden">
                   <div className="relative block lg:hidden">
                    <div className="max-w-full px-4 py-4 mx-auto bg-fixed"
            ...
            <div className="w-full lg:w-3/5 lg:pl-16 ml-auto">
              ...
              <div className="flex flex-wrap mb-16 lg:mb-4">
                ...
                <a
                  ...
                  href="https://medium.com/creaton/creaton-our-mission-a07a658a92b3">Learn More</a>
              </div>
              <div className="flex flex-wrap items-center justify-center mb-4 lg:w-96">
                <div className="flex lg:flex-none justify-center lg:justify-start w-1/5 px-2"><a
              ...
              <div className="flex flow-row flex-wrap items-center justify-center pl-2 lg:-ml-36">
                <div className="w-1/2 md:w-1/3 lg:w-1/6 px-2"><img
                  ...
                  src="./assets/images/logo-polygon.png" alt=""/></div>
                <div className="w-1/2 md:w-1/3 lg:w-1/6 px-2"><img
                  className="mx-auto lg:mx-0 filter grayscale contrast-0 opacity-75" src="./assets/images/brand-2.png"
                  alt=""/></div>
                <div className="w-1/2 md:w-1/3 lg:w-1/6 px-2"><img
                  className="mx-auto lg:mx-0 filter grayscale contrast-0 opacity-75 lg:pl-4"
                  src="./assets/images/brand-5.png" alt=""/></div>
                <div className="w-1/2 md:w-1/3 lg:w-1/6 px-2"><img
                  className="mx-auto lg:mx-0 filter grayscale contrast-0 opacity-75 transform scale-50"
                  src="./assets/images/brand-3.png" alt=""/></div>
                <div className="w-1/2 md:w-1/3 lg:w-1/6 px-2"><img
