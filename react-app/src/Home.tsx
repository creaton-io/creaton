                ...
                <div className="w-full lg:w-3/5 lg:pl-16 ml-auto">
                  ...
                  <div className="flex flex-wrap items-center justify-center lg:w-96">
                    ...
                    <div className="flex lg:flex-none justify-center lg:justify-start w-1/5 px-2 mb-12"><a
                      ...
                      <svg width="24" height="24" className="fill-current text-light-blue-400 transform scale-150"
                           viewBox="0 0 24 24">
                        <path
                    ...
                    <div className="flex lg:flex-none justify-center lg:justify-start w-1/5 px-2 mb-12"><a
                      ...
                      <svg width="24" height="24" className="fill-current text-light-blue-500 transform scale-150"
